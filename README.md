...
- Two parts of expressed that I learned about this week would be using building RESTful APIs and Routing

- [x] Describe Middleware?

- Middleware is is an array of functions that get executed in the order they are presented into the server. Some are built-in, but also can be added through yarn, or created manually. 

- [x] Describe a Resource?

- Things you can install to your application by using yarn or npm. 

- [x] What can the API return to help clients know if a request was successful?

- The API can return status codes to help let clients know if a request was sucessful.

- [x] How can we partition our application into sub-applications?

- By sepreation of concerns, seperating routes into seperate router folders instead of adding all routes to your server.js. Just seperating files so everything isn't bunched together.
